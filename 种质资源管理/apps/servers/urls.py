...
from .views import ServerListView, ServerAddView, ServerDetailView, ServerModifyView, ServerDeleteView, \
    ServerExportView, ServerImportView, ServerQRcodeView
...
urlpatterns = [
    ...
    path('server/import/', ServerImportView.as_view(), name='server_import'),
    ...
    path('server/qrcode/<int:server_id>/', ServerQRcodeView.as_view(), name='server_qrcode'),
