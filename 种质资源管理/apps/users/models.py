...
class UserProfile(AbstractUser):
    staff_no = models.CharField(max_length=15, verbose_name='学号/工号', blank=True)
    department = models.CharField(max_length=15, verbose_name='实验室/办公室', blank=True)
    ...
    is_staff = models.CharField(max_length=10, choices=(('1', '是'), ('0', '否')),
                                verbose_name='是否在校', default='1', blank=True)
