    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('staff_no', models.CharField(blank=True, max_length=15, verbose_name='学号/工号')),
                ('department', models.CharField(blank=True, max_length=15, verbose_name='实验室/办公室')),
                ...
                ('is_staff', models.CharField(blank=True, choices=[('1', '是'), ('0', '否')], default='1', max_length=10, verbose_name='是否在校')),
